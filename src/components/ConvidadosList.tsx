...
export const ConvidadosList: React.FC<ConvidadosListProps> = ({ convidados, formandos }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-3xl font-bold text-gradient mb-2">Lista de Convidados</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="input-elegant w-full pl-10 pr-4 py-2 focus-ring state-transition"
            />
          </div>
          ...
          <select
            ...
            className="input-elegant px-4 py-2 focus-ring state-transition"
          >
      ...
      <div className="card-elegant overflow-hidden hover-lift">
        {filteredConvidados.length === 0 ? (
          <div className="p-12 text-center">
            <Filter className="w-12 h-12 text-gray-400 mx-auto mb-4 animate-pulse-custom" />
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredConvidados.map((convidado) => (
                  <tr key={convidado.id} className="hover:bg-gray-50 state-transition">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="flex-shrink-0">
                          <div className="w-10 h-10 gradient-primary rounded-full flex items-center justify-center hover-scale">
      ...
      {/* Resumo */}
      <div className="bg-gray-50 rounded-xl p-6 animate-slide-in">
